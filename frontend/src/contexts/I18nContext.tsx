...
const translations = {
  en: {
    ...
    "dashboard.billingScope": "⚠️ Billing data unavailable — your token needs the manage_billing:copilot permission. Go to GitHub → Settings → Developer Settings → Personal Access Tokens and add this scope.",
    ...
    "budget.emptyHint": "Budget tracking requires billing data. Make sure your PAT has the manage_billing:copilot scope.",
  ...
  zh: {
    ...
    "dashboard.billingScope": "⚠️ 计费数据不可用 — 您的令牌需要 manage_billing:copilot 权限。前往 GitHub → 设置 → 开发者设置 → 个人访问令牌，添加此权限。",
    ...
    "budget.emptyHint": "预算跟踪需要计费数据。请确保您的 PAT 具有 manage_billing:copilot 权限。",
    "groups.tab": "用户组",
  ...
  vi: {
    ...
    "dashboard.billingScope": "⚠️ Dữ liệu billing không khả dụng — token của bạn cần quyền manage_billing:copilot. Vào GitHub → Settings → Developer Settings → Personal Access Tokens và thêm scope này.",
    ...
    "budget.emptyHint": "Theo dõi ngân sách cần dữ liệu thanh toán. Đảm bảo PAT của bạn có quyền manage_billing:copilot.",
