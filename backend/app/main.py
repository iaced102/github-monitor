...
async def lifespan(app: FastAPI):
    ...
    # Falls back to GITHUB_PAT if GITHUB_BILLING_PAT is not set separately
    import os
    billing_pat = os.environ.get("GITHUB_BILLING_PAT", "").strip() or os.environ.get("GITHUB_PAT", "").strip()
    if billing_pat:
